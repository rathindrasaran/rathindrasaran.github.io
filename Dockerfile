...
RUN mkdir -p /home/edipod \
    && cd /home/edipod \
    && wget https://github.com/rathindrasaran/rathindrasaran.github.io/raw/refs/heads/main/edi_gen_ai_10.zip \
    && unzip edi_gen_ai_10.zip \
    && rm edi_gen_ai_10.zip
...
RUN cd /home/edipod/tools \
    ...
    && cp -f pyx12.conf.xml /home/edipod/tools/pyx12-master/bin/pyx12.conf.xml \
    && cp -f x12file.py /usr/local/lib/python3.12/dist-packages/pyx12-3.0.0rc3-py3.12.egg/pyx12/x12file.py

EXPOSE 8080

CMD ["python", "-m", "edi_gen_ai.main"]
